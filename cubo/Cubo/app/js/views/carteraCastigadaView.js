export function renderCarteraCastigada() {
  setTimeout(() => {
    ...
    btn.onclick = async () => {
      ...
      const res = await buscarRespuesta('carteraCastigada', input.value);
  ...
  return `
    <section class="dashboard-section">
      ...
      <img src="app/images/carteraCastigada/icono.png" alt="Icono de Cartera Castigada" class="indicador-img mx-auto my-4">
